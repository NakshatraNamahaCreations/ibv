                    ...
                    <div class="card-block">
                      ...
                      <div class="row">
                        ...
                        <div className="col-md-6 pb-3">
                          {" "}
                          <img
                            src={`http://api.infinitimart.in/documents/${user?.adharfrontendimg}`}
                            class="img-radius"
                        ...
                        <div className="col-md-6 pb-3">
                          <img
                            src={`http://api.infinitimart.in/documents/${user?.adharbackendimg}`}
                            class="img-radius"
                        ...
                        <div className="col-md-6">
                          ...
                          <img
                            src={`http://api.infinitimart.in/documents/${user?.panimg}`}
                            class="img-radius"
                            alt={user?.panimg}
